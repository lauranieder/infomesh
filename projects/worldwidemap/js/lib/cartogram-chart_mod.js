...
(function (global, factory) {
  ...
  var cartogram = new Kapsule({
    ...
    update: function update(state) {
      ...
      // console.log(features.enter().append);
      if(__first){
        var list_r = [];
        let list = features.enter()._groups;
        console.log(list);
        for(let i in list[0]){
          // console.log(list[0][i]);
          list_r.push([list[0][i].__data__.properties.ISO_A3, list[0][i].__data__.properties.NAME, list[0][i].__data__.properties.ISO_A2]);
        }
        console.log(list_r);///////_________________________________*BOOOOOOM*
      }
      ...
      if(__first){
        $("svg.cartogram").children().each(function(i){
          //console.log(list_r);///////_________________________________*BOOOOOOM*
          $(this).attr("name", list_r[i][1]);
          $(this).attr("ISO_A3", list_r[i][0]);
          $(this).attr("ISO_A2", list_r[i][2]);
        });
        __first = false;
      }
